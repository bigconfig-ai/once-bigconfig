...
A BigConfig Package (<ExternalLink href="https://bigconfig.it/blog/introducing-bigconfig-package/">announcement</ExternalLink>) is a standard Clojure project. The core logic of a package is a function authored via the <ExternalLink href="https://bigconfig.it/api/workflow/">BigConfig Workflow</ExternalLink>.
