    ...
    (let [re-opts (into {} [[:cmd cmd ]
      ...
      (add-stop-fn opts (fn [{:keys [::proc] :as opts}]
                          (when proc
                            (destroy! proc 1000))))))
  ```
<p><sub><a href="https://github.com/bigconfig-ai/big-config/blob/main/src/clj/big_config/system.clj#L114-L133">Source</a></sub></p>
...
Destroy a `babashka.process/process`.
  ...
  ```
<p><sub><a href="https://github.com/bigconfig-ai/big-config/blob/main/src/clj/big_config/system.clj#L39-L53">Source</a></sub></p>
...
Map of the environment variables keywordized. All `_` are transformed
  ...
  (env :path)
  ```
<p><sub><a href="https://github.com/bigconfig-ai/big-config/blob/main/src/clj/big_config/system.clj#L24-L34">Source</a></sub></p>
    ...
    (let [re-opts (into {} [[:cmd cmd ]
      ...
      (add-stop-fn opts (fn [{:keys [::proc] :as opts}]
                          (when proc
                            (destroy! proc 1000))))))
  ```
<p><sub><a href="https://github.com/bigconfig-ai/big-config/blob/main/src/clj/big_config/system.clj#L55-L112">Source</a></sub></p>
  ...
  (->workflow {:first-step ::start
               :wire-fn (fn [step _]
                          (case step
                            ...
                            ::end [stop]))})
  ```
<p><sub><a href="https://github.com/bigconfig-ai/big-config/blob/main/src/clj/big_config/system.clj#L135-L153">Source</a></sub></p>
...
<p><sub><a href="https://github.com/bigconfig-ai/big-config/blob/main/src/clj/big_config/system.clj#L155-L159">Source</a></sub></p>
