...
<p><sub><a href="https://github.com/bigconfig-ai/big-config/blob/main/src/clj/big_config/render.clj#L179-L181">Source</a></sub></p>
...
This is the functional version of the template engine. See the
  [`big-config.render`](#big-config.render) namespace for more information.
<p><sub><a href="https://github.com/bigconfig-ai/big-config/blob/main/src/clj/big_config/render.clj#L283-L341">Source</a></sub></p>
...
This is the workflow version of the template engine. See the
  [`big-config.render`](#big-config.render) namespace for more information.
<p><sub><a href="https://github.com/bigconfig-ai/big-config/blob/main/src/clj/big_config/render.clj#L343-L353">Source</a></sub></p>
