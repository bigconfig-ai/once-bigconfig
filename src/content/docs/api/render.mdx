...
<p><sub><a href="https://github.com/amiorin/big-config/blob/main/src/clj/big_config/render.clj#L281-L339">Source</a></sub></p>
...
This is the workflow version of the template engine. See the
  [`big-config.render`](#big-config.render) namespace for more information.
<p><sub><a href="https://github.com/amiorin/big-config/blob/main/src/clj/big_config/render.clj#L341-L351">Source</a></sub></p>
