...
## Conclusion
Getting started with BigConfig for dotfiles doesn't require knowing Clojure for the basic operations. You can read more about this use case in this <ExternalLink href="/blog/a-new-approach-to-dotfiles-management-with-bigconfig/">blog article</ExternalLink>.
