...
1.  Install the Control Plane CLI:
    ```sh
    clojure -Ttools install big-config/control-plane '{:git/sha "aff7c186999c19ad2b4f07752abd13ec5b3b6651" :git/url "https://github.com/bigconfig-ai/big-config.git"}' :as ctlp
    ```
