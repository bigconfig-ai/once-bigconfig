...
3. **Lib:** For deep automation. You can orchestrate complex scenarios without reimplementing anything when switching gear from CLI tool to in-house solution.
