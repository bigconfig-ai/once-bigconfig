...
I built a simple HDA <ExternalLink href="https://example.bigconfig.ai/">example</ExternalLink> to prove the concept. When you open it in two separate browser tabs and interact with one, the other updates instantly.
