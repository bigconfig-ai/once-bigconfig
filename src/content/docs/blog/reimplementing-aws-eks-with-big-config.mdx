...
BigConfig
Cloud
BigConfig executed by Rama instead of a user: {
  Rama.t1 -> GitHub: clone the infracode
  Rama.t1 -> BigConfig: build the infracode with the desired state
  Rama.t1 -> Cloud: create the resources
}
