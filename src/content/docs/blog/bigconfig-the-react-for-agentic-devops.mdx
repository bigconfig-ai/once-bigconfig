...
2.  **[BigConfig](https://github.com/bigconfig-ai/big-config) source code:** The framework for "infrastructure components." It reduces token consumption by using high-level abstractions.
